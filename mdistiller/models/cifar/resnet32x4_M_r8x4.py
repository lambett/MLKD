...
import numpy as np
from mdistiller.models.cifar.resnet import resnet32x4, resnet8x4
# from models import *
...
class res32x4_M_r8x4(nn.Module):
    def __init__(self, num_classes=100):
        super(res32x4_M_r8x4, self).__init__()
        self.class_num = num_classes

        self.proj_head_in_features = 256 * 3
    ...
    def forward(self, x, is_feat=False):
        ...
        return feats, out_multi



if __name__ == '__main__':
    model = res32x4_M_r8x4()
    import random
    dif_labels = random.choices(range(3), k=50000)
    labels = random.choices(range(100), k=50000)
    model.set_diff_level(dif_labels, labels)
