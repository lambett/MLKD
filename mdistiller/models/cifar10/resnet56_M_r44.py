...
import numpy as np
from mdistiller.models.cifar.resnet import resnet44
# from models import *
...
class res56_M_r44(nn.Module):
    def __init__(self, num_classes=10):
        super(res56_M_r44, self).__init__()
